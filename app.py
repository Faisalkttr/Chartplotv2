...
# rel. momentum, capture ratios, crisis alpha, rank-based composite);
# (4) Sizing & Stress anti-fragile panel (cash governor, risk-parity lens,
# concentration + liquidity audit).
# 
...
PORTFOLIO_GRID = {
    ...
    "ENERGY & COMMODITY (18%)": {
        ...
        "Layer 2: Baseload & Nuclear Fuel (40%)": {
            "tickers": ["CCJ", "UUUU", "CNQ", "XOM", "SU", "EQT", "CVX", "CNR.TO", "DTM", "IMO", "NTOIY", "DINO"],
            "benchmark": "XLE"},
...
SECTION_TARGETS = {"INFRA": 0.14, "ENERGY & COMMODITY": 0.18, "AI / SEMIS": 0.10, "EM": 0.07,
                   "Biz & Futuristic Overlay": 0.06, "ROBOTICS": 0.05,
                   "BTC": 0.25, "GOLD": 0.10, "CASH": 0.10}
