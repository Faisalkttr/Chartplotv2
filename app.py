...
PORTFOLIO_GRID = {
    ...
    "ROBOTICS (5%)": {
        "Layer 1: Motion, Actuation & Factory Logistics (35%)": {
            # 6954.T = Fanuc (TSE, local ticker; ADR FANUY already used in AI/SEMIS)
            # 6268.T Nabtesco, 6594.T Nidec, 6273.T SMC Corp, 6383.T Daifuku
            "tickers": ["6954.T", "6268.T", "6594.T", "6273.T", "6383.T"],
            "benchmark": "ROBO"},
        "Layer 2: Sense, Control & Digital Twin (20%)": {
            # OMRNY Omron ADR, CGNX Cognex, AME Ametek, DSY.PA Dassault Systemes
            "tickers": ["OMRNY", "CGNX", "AME", "DSY.PA"],
            "benchmark": "BOTZ"},
        "Layer 3: Edge & Power Silicon (30%)": {
            # IFX.DE Infineon, NXPI, MCHP, TXN, RNECY Renesas ADR, ARM, ASX (ASE Technology ADR)
            "tickers": ["IFX.DE", "NXPI", "MCHP", "TXN", "RNECY", "ARM", "ASX"],
            "benchmark": "SMH"},
        "Layer 4: EMS & Integration (15%)": {
            # FLEX Flex, JBL Jabil, TEL TE Connectivity
            "tickers": ["FLEX", "JBL", "TEL"],
            "benchmark": "XLI"}}}

SECTION_TARGETS = {"INFRA": 0.13, "ENERGY & COMMODITY": 0.17, "AI / SEMIS": 0.09, "EM": 0.07,
                   "Biz & Futuristic Overlay": 0.05, "BTC": 0.24, "GOLD": 0.10, "CASH": 0.10,
                   "ROBOTICS": 0.05}
LIQUIDITY_WATCH = {"LYSCF", "IKTSY", "BABAF", "CSUAY", "0941.HK", "ALMU",
                   "KAP.IL", "FUWAY", "RNECY", "OMRNY"}
